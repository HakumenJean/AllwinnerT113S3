...
struct property_t g_lcd0_config_rgb[] = {
    ...
    },
    {
        .name = "lcd_if",
        .type = PROPERTY_INTGER,
        .v.value = LCD_IF_HV, /* LCD_IF_HV */
    },
    {
        .name = "lcd_hv_if",
        .type = PROPERTY_INTGER,
        .v.value = LCD_HV_IF_PRGB_1CYC, /* LCD_HV_IF_PRGB_1CYC */
    },
    {
        .name = "lcd_x",
        .type = PROPERTY_INTGER,
    ...
    {
        .name = "lcd_frm",  // 弥补色深， 0: rgb888 -> rgb 888; 1: rgb888 -> rgb666; 2: rgb888 -> rgb565
        .type = PROPERTY_INTGER,
        .v.value = 1,
    },
    {
