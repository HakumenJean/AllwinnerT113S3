...
#ifndef DRIVERS_HAL_DISP2_DISP_DE_INCLUDE_H_
#define DRIVERS_HAL_DISP2_DISP_DE_INCLUDE_H_
...
#define DE_INF(...)  asm("nop")
#define DE_HERE(...) asm("nop")
#define DE_DBG(...)  asm("nop")
#define DE_WRN(fmt, ...) do {hal_log_warn("disp:[%s %d]"fmt, __func__, __LINE__, ##__VA_ARGS__);} while (0)
#else
...
#define DE_WRN(fmt, ...) asm("nop")
#endif

#define DISP_PRINT hal_printf
...
#ifndef hal_abs
#define hal_abs(x) (((x)&0x80000000) ? (0-(x)):(x))
#endif
