...
#ifndef DRIVERS_HAL_CE_CE_REG_H_
#define DRIVERS_HAL_CE_CE_REG_H_
...
#define CE_DES_MODE_ECB             0
#define CE_DES_MODE_CBC             1
#define CE_DES_MODE_CTR             2
...
#endif /* DRIVERS_HAL_CE_CE_REG_H_ */
