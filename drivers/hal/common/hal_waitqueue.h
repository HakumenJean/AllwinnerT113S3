...
#ifndef DRIVERS_HAL_COMMON_HAL_WAITQUEUE_H_
#define DRIVERS_HAL_COMMON_HAL_WAITQUEUE_H_
...
#define hal_waitqueue_head_init(q) \
    do {                                    \
        (q)->lock = (hal_spinlock_t)HAL_SPINLOCK_INIT;   \
...
#endif /* DRIVERS_HAL_COMMON_HAL_WAITQUEUE_H_ */
