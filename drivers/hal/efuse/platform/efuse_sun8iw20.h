...
#ifndef DRIVERS_HAL_EFUSE_PLATFORM_EFUSE_SUN8IW20_H_
#define DRIVERS_HAL_EFUSE_PLATFORM_EFUSE_SUN8IW20_H_
...
#define SUNXI_SYSCFG_VER        (0x03000000 + 0x24)
#define VER_MARK                (0x7)
...
#define SCC_THERMAL_SENSOR_BURNED_FLAG  (2)
#define SCC_FT_ZONE_BURNED_FLAG (3)
...
/* Configure rtc domain efuse power switch */
#define EFUSE_HV_SWITCH         (0x07090000 + 0x204)

#endif /* DRIVERS_HAL_EFUSE_PLATFORM_EFUSE_SUN8IW20_H_ */
