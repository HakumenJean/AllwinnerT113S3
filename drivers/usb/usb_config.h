...
#ifndef PACKAGES_CHERRYUSB_V1_3_1_COMMON_USB_CONFIG_H_
#define PACKAGES_CHERRYUSB_V1_3_1_COMMON_USB_CONFIG_H_

#define CONFIG_USB_EHCI_T113
#define CONFIG_USB_DFS_MOUNT_POINT  "/sd%c"
